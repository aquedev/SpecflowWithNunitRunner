...
namespace TechTalk.SpecFlow
{
    ...
    {
        ITestRunner CreateTestRunner(Assembly testAssembly, bool asynca);
        ITestRunner GetTestRunner(Assembly testAssembly, bool asynca);
    }
    ...
    public class TestRunnerManager : ITestRunnerManager, IDisposable
    {
        ...
        private class TestRunnerKey
        {
            ...
            public TestRunnerKey(Assembly testAssembly, bool asynca)
            {
        ...
        public ITestRunner CreateTestRunner(Assembly testAssembly, bool asynca)
        {
            return CreateTestRunner(new TestRunnerKey(testAssembly, asynca));
        }
        ...
        public ITestRunner GetTestRunner(Assembly testAssembly, bool asynca)
        {
            return GetTestRunner(new TestRunnerKey(testAssembly, asynca));
        }
