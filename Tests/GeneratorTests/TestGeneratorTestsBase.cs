...
");
        ...
        protected TestGenerator CreateTestGenerator(ProjectSettings projectSettings)
        {
            ...
            UnitTestFeatureGenerator unitTestFeatureGenerator = new UnitTestFeatureGenerator(new NUnitTestGeneratorProvider(codeDomHelper,null), codeDomHelper, generatorConfiguration, new DecoratorRegistryStub(), null);
