...
namespace TechTalk.SpecFlow.RuntimeTests
{
    ...
    public class TestRunnerManagerTest
    {
        ...
        {
            var testRunner = testRunnerManager.CreateTestRunner(anAssembly, asynca: false);
        ...
        {
            var testRunner = testRunnerManager.CreateTestRunner(anAssembly, asynca: true);
        ...
        {
            var testRunner = testRunnerManager.GetTestRunner(anAssembly, asynca: false);
        ...
        {
            var testRunner = testRunnerManager.GetTestRunner(anAssembly, asynca: true);
        ...
        {
            var testRunner1 = testRunnerManager.GetTestRunner(anAssembly, asynca: false);
            var testRunner2 = testRunnerManager.GetTestRunner(anAssembly, asynca: false);
        ...
        {
            var testRunner1 = testRunnerManager.GetTestRunner(anAssembly, asynca: false);
            var testRunner2 = testRunnerManager.GetTestRunner(anAssembly, asynca: true);
        ...
        {
            var testRunner1 = testRunnerManager.GetTestRunner(anAssembly, asynca: false);
            var testRunner2 = testRunnerManager.GetTestRunner(anotherAssembly, asynca: false);
